...
config :swati, SwatiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "uu5zGknyLzz2s5F5v3U5x3MjNrGXC2/M3NrQ36WFNfX+q+4K2WDodKYNOxhfJ3MZ",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:swati, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:swati, ~w(--watch)]}
  ]
...
config :swati, SwatiWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/swati_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :swati, dev_routes: true
