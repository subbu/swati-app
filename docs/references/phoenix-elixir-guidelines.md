# Phoenix/Elixir implementation guidelines

Detailed framework rules moved from `AGENTS.md` to keep root guide short.
Canonical for Phoenix/Elixir/LiveView/HEEx/Ecto details.

Last moved: 2026-02-28
...
- Avoid using hand-crafted css or classes. Use inline tailwind classes to the most part.
