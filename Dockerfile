...
#   - Ex: docker.io/hexpm/elixir:1.18.3-erlang-26.2.5-debian-trixie-20251229-slim
#
...
# install JS dependencies for bundling
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/swati ./
